...
#   Defaults to 'https://github.com/kettlewell/prelude.git'
# -i/--into
...
usage() {
    ...
    printf "  \t \t \t \t Defaults to 'https://github.com/kettlewell/prelude.git'.\n"
...
[ -z "$PRELUDE_URL" ] && PRELUDE_URL="https://github.com/kettlewell/prelude.git"
